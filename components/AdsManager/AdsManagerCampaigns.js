        ...
        <>
            ...
            {boostedProjects && boostedProjects[0] && (
                <div className="container max-w-screen-xl px-4 md:px-.5 lg:px-.5 xl:px.5 mb-8 mt-4 mx-auto ">
                    ...
                    {grid === true && (
                        <div className="md:visible invisible h-0 md:h-auto grid grid-cols-1 md:grid-cols-3 md:gap-x-20 md:gap-y-8 gap-x-16 gap-y-1 relative">
                    ...
                    {grid === false && (
                        <div className="md:visible invisible h-0 md:h-auto grid grid-cols-1  md:gap-y-8  gap-y-3 relative">
                            {boostedProjects.map(project => {
                                let cardImage =
                                    project.projectId && project.projectId.images[0]
                                        ? publicRuntimeConfig.API_URL +
                                          '/media/project/' +
                                          project.projectId.images[0]
                                        : publicRuntimeConfig.API_URL +
