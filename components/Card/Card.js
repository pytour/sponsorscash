...
const Card = props => {
    ...
    const handleProjectDetailsRoute = () => {
        if (props.boosted) {
            axios
                .post(
                    publicRuntimeConfig.ADS_SERVER_URL + '/api/ads/registerView',
                    {
                        bidId: props.bidId
                    },
                    {}
    ...
    return (
        <>
            {!props.smallCard && (
                <div className="group rounded-custom overflow-hidden shadow-lg ">
                    ...
                    <div className="pt-2 px-3 flex justify-between">
                        <div className="text-sm py-1.5 px-1.5 bg-shadow-card bg-opacity-25 rounded-xl text-progress-bar text-center">
                            {props.tag}
                        </div>
                        ...
                        {props.boosted && (
                            <div className="flex justify-between">
                                <div>
                                    <img src={'/images/boosterIcon.svg'} className="w-8 h-8" alt="image"/>
                                </div>
                            </div>
                        )}
                    </div>
                    ...
                    <div
                        className="cursor-pointer px-3 pt-1 pb-3"
            ...
            {props.smallCard && (
                <div className="group rounded-md overflow-hidden shadow-lg ">
