                    ...
                    <span
                      ...
                      X
                        ...
                        <div className="relative p-6 flex-auto text-center">
                            ...
                            <p className="py-6 text-green-600 text-2xl font-bold"> Congratulations, Your project is
                                ready to go!
                            </p>

                            <p className="py-2 text-green-600 text-xl ">We have created an wallet for you. Please
