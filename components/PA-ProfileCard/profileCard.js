    ...
    return (
        <div className="my-7 max-w-screen-xl mx-auto container">
            <div
                className={
                    ' grid grid-cols-12   ' +
                    (editMode ? 'px-4 md:px-4 lg:px-4' : 'px-4 md:px-8 lg:px-4')
                }>
                <div className={'col-span-12 lg:col-span-2'}>
                    <div
                        className={
                            'relative w-48 h-48  overflow-hidden m-auto rounded-full border-8 border-outline-color shadow-md z-20 md:z-20  left-0  md:top-customCalc md:shadow-lg justify-items-center ' +
                            (editMode ? 'lg:left-0' : '   xl:mt-1 lg:left-0')
                        }>
                        {isImageSet && (
                            <AvatarEditor
                                ref={setEditor}
                ...
                <div
                    className={
                        ' -my-6 lg:my-2 col-span-12 lg:col-span-10 text-center py-4 shadow-md border  rounded-50px  w-full' +
                        (editMode ? 'lg:-ml-12 xl:-ml-12 ml-0' : '-ml-12  lg:-ml-12 xl:-ml-12 ')
                    }>
                    <div className="flex flex-row  pt-12  lg:py-2 relative">
                        {props.showEditButton && (
                            <button
                                ...
                                <i className="text-branding-text-color fas fa-pencil-alt" />
                            </button>
                        )}
                        {editMode && (
                            <button
                    ...
                    <div
                        className={
                            'grid grid-cols-12 pt-2 ' +
                            (editMode ? 'px-2 lg:px-0  gap-x-8 mt-4 ' : 'px-4')
                        }>
                        ...
                        <div
                            ...
                            {editMode ? (
                                <div className="">
                                    <p className="text-left text-outline-color  text-md  overflow-hidden  mb-2">
                                        User Name
                                    </p>
                                    <input
                                ...
                                <h3 className="text-outline-color pt-6 lg:pt-0 text-3xl overflow-hidden ">
                                    {userData.name}
                                </h3>
                            )}
                            ...
                            {!editMode && (
                                <p className="text-percentage text-sm overflow-hidden ">
                                    member since:{' '}
                                    {userData.memberSince ? userData.memberSince.split('T')[0] : ''}
                                </p>
                            )}
                            {editMode ? (
                                <div className="py-4">
                            ...
                            {editMode && (
                                <div className="mt-2 py-2">
                                    ...
                                    <input
                                        ...
                                        name="facebook"
                                        value={
                                            userData.socialLinks && userData.socialLinks.facebook
                                        }
                            ...
                            {editMode && (
                                <div className="py-2">
                                    ...
                                    <input
                                        ...
                                        value={
                                            userData.socialLinks && userData.socialLinks.telegram
                                        }
                                        className="w-full p-1.5  rounded-xl text-leftrounded-sm border-1 border-outline-color focus:outline-none"
                                        onChange={updateValue}
                                    />
                        ...
                        <div
                            className={
                                'text-center lg:mr-8 mr-0' +
                                (editMode
                                    ? ' col-span-12  lg:col-span-6  px-0'
                                    : ' col-span-12  lg:col-span-7 px-4')
                            }>
                            {editMode ? (
                                <div className="py-0">
                                    <p className=" text-left text-outline-color  text-md  overflow-hidden  mb-2">
                                ...
                                {!editMode &&
                                    (userData.socialLinks && userData.socialLinks.telegram && (
                                        <a
                                            ...
                                            <i className="group-hover:text-white text-branding-color  fab fa-telegram-plane" />
                                        </a>
                                    ))}
                                {editMode ? (
                                    <div className="py-2">
                                        ...
                                        <input
                                            ...
                                            placeholder="Twitter"
                                            value={
                                                userData.socialLinks && userData.socialLinks.twitter
                                            }
                                            className="w-full p-1.5   rounded-xl text-leftrounded-sm border-1 border-outline-color focus:outline-none"
                                            onChange={updateValue}
                                        />
                                    ...
                                    userData.socialLinks.twitter && (
                                        <a
                                            ...
                                            className="hover:text-white hover:bg-branding-text-color block w-10 h-10 border-1 border-outline-color  rounded-full pt-2 text-center mr-3 md:mr-2 group">
                                            <i className="group-hover:text-white text-branding-color fab fa-twitter" />
                                        </a>
                                    )
                                )}
                                {editMode ? (
                                    ...
                                    userData.socialLinks.email && (
                                        <a
                                            ...
                                            <p className="group-hover:text-white text-branding-color text-black text-2xl">
                                                r
                                            </p>
                                        </a>
                                    )
