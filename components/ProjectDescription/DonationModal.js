                            ...
                            <div className="border-0 rounded-lg shadow-lg relative flex flex-col w-full bg-white outline-none focus:outline-none">
                                ...
                                <div className="flex items-center justify-center p-3 border-b border-solid border-gray-300 rounded-t">
                                    <h4 className="text-2xl text-center font-semibold">
                                        {props.receivingAddress ? 'Bitcoin Cash Address' : 'Donate'}
                                    </h4>
                                    <button
                                ...
                                {!props.receivingAddress && (
                                   ...
                                   focus:border-purple-300  focus:outline-none
                                    border-1 focus:border-0  bg-transparent"
                                                    ...
                                                    props.formik.errors.amount ? (
                                                        <Warning
                                                            message={props.formik.errors.amount}
                                                        />
                                                    ) : null}
                                                </div>
                                            </div>
                                   ...
                                   focus:border-purple-300  focus:outline-none
                                    border-1 focus:border-0  bg-transparent"
                                                    ...
                                                    props.formik.errors.name ? (
                                                        <Warning
                                                            message={props.formik.errors.name}
                                                        />
                                                    ) : null}
                                                </div>
                                            </div>
                                   ...
                                   focus:border-purple-300  focus:outline-none
                                    border-1 focus:border-0  bg-transparent"
                                                />
                                                {props.formik.touched.comment &&
                                                props.formik.errors.comment ? (
                                                    <Warning
                                                        message={props.formik.errors.comment}
                                                    />
                                                ) : null}
                                            </div>
                                        </div>
                                        {/*footer*/}
                                        <div className="flex items-center justify-center p-6 border-t border-solid border-gray-300">
                                            <button
                                                className="bg-branding-color mr-4 text-white active:bg-branding-color font-bold uppercase text-sm md:px-12 px-6 py-2 rounded-lg shadow hover:shadow-lg outline-none focus:outline-none mb-1"
                                                type="submit"
                                                style={{ transition: 'all .15s ease' }}>
                                                Get Address
                                            </button>
                                            <button
                                                className="text-white bg-gray-400 rounded-lg font-bold uppercase px-6 py-2 text-sm outline-none focus:outline-none mr-1 mb-1"
                                                type="button"
                                                style={{ transition: 'all .15s ease' }}
                                ...
                                {props.receivingAddress && (
                                    <div>
                                        <div className="p-2 flex-auto text-center">
                                        ...
                                        <div className="flex items-center justify-center p-4  border-solid border-gray-300 rounded-b">
                                            <CopyToClipboard
                                                text={props.receivingAddress}
                                                onCopy={props.onCopy}>
                                                <button
                                                    className="text-white  bg-branding-color rounded-lg font-bold uppercase px-6 py-3 text-center text-sm outline-none focus:outline-none mr-1 mb-1"
                                                    type="button"
                                                    style={{ transition: 'all .15s ease' }}
