                ...
                <div
                    ...
                    <div className="mx-auto p-4 bg-white shadow-md rounded-2xl">
                        ...
                        <form onSubmit={formik.handleSubmit}>
                            <h2 className="pt-0 pb-4  text-outline-color text-2xl uppercase text-center">sign up</h2>
                            ...
                            <button type="submit" className="w-full text-white rounded-2xl h-10 uppercase bg-login-bg bg-opacity-75 text-lg hover:shadow-xl shadow-md  mb-6 mt-6">
                                REGISTER
                            </button>
                        </form>
