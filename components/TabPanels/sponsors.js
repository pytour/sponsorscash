                    ...
                    <div className=" bg-white border-1 border-gray-100 md:p-5 p-3 rounded-md tracking-wide shadow">
                        <div className="grid grid-cols-12 gap-4">
                            ...
                            <div className="col-start-5 col-end-13 py-2 md:py-4">
                                ...
                                <div className="font-medium text-gray-400 pt-1"> <TimeAgo date={new Date(props.date)} formatter={formatter}/> </div>
                                <div
                                    className=" mt-2 md:text-lg text-gray-600 text-sm">{props.comment ? props.comment : "No Comment"}</div>
