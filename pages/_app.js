...
export default function MyApp({ Component, pageProps }) {
  ...
  const metaTitle =
      pageProps.project && pageProps.project.title
        ? pageProps.project.title
        : "Fundme.Cash";
  ...
  return (
    <React.Fragment>
      <Head>
        <title>Fundme Cash BETA</title>
        <meta charSet="utf-8" />
        <meta name="viewport" content="initial-scale=1.0, width=device-width" />
        <meta property="og:site_name" content="Fundme.Cash" key="ogsitename" />
        <meta property="og:title" content={metaTitle}  key="ogtitle" />
        <meta property="og:description" content={metaDesc}  key="ogdesc" />
        <meta property="og:type" content="website" />
        {/* https://ogp.me/#types */}
        <meta property="og:url" content="https://fundme.cash/"  key="ogurl" />
        <meta property="og:image" content={metaImg}  key="ogimage" />
        <script
          async
          src="https://www.googletagmanager.com/gtag/js?id=UA-173074051-1"
        />
