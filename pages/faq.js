                    ...
                    <div className="p-8">
                        <div className="w-full text-center mx-auto bg-card h-auto shadow-lg my-1">
                            ...
                            <div
                                className={
                                    open1
                                        ? 'visible h-auto transition duration-700 ease-in-out'
                                        : 'h-0 invisible pb-2'
                                }>
                                {open1 && (
                                    <div className={'border py-4 px-6 bg-white shadow-xl'}>
                                        No. We do hold campaign funds. If you don’t feel comfortable
                                        with this we recommend trying out flipstarter.cash. They
                                        offer a non-custodial option. The folks at{' '}
                                        <a href="https://t.me/flipstarter">flipstarter</a> have
                                        spent a lot of time on this project and are very helpful.
                                    </div>
                                )}
                            </div>
                        </div>
                        ...
                        <div className="w-full text-center mx-auto bg-card h-auto shadow-lg my-1">
                            ...
                            <div className={open3 ? 'h-auto visible ' : 'invisible h-0'}>
                                {open3 && (
                                    <div className={'border py-4 px-6 bg-white shadow-xl'}>
                                        We don’t want to moderate this platform, but some people
                                        just want to watch the world burn. <br />
                        ...
                        <div className="w-full text-center mx-auto bg-card h-auto shadow-lg my-1">
                            ...
                            <div className={open5 ? 'h-auto visible ' : 'invisible h-0'}>
                                {open5 && (
                                    <div className={'border py-4 px-6 bg-white shadow-xl'}>
                                        We won’t hold any funds ransom to collect any data other
                                        than what is required at signup. <br />
                            ...
                            <div className={open6 ? 'h-auto visible ' : 'invisible h-0'}>
                                {open6 && (
                                    <div className={'border py-4 px-6 bg-white shadow-xl'}>
                                        <ul>
                                            <li>
                                                Logged in users - Donate with Badger and your
                                                name/avatar will be shown in Last Donors tab
                                            </li>
                                            <br />
                                            <li>
                                                Anonymous - Any user can click ‘Pay’ and receive the
                                                BCH address to send donations. They will appear as
                                                Anonymous after one confirmation on the BCH
                                                blockchain.
                                            </li>
                                        </ul>
                                    </div>
