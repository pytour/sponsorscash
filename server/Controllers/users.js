                        ...
                        user.save(function(err) {
                            ...
                            token.save(function(err) {
                                ...
                                let mailOptions = {
                                    ...
                                    text:
                                        'Hello,\n\n' +
                                        'Please verify your Sponsors.cash account by clicking the link:\n' +
                                        verifyURL,
                                    html: `<b>Hello<br>Please verify your Sponsors.cash account by clicking the link:</b>
...
exports.updateUserProfile = (req, res) => {
    ...
    if (userImage) {
        ...
        let imagePath = path.normalize(__dirname + `/../../public/UserImages/${staticPath}`);
    ...
    User.findOne({ _id: req.decodedTokenData.userId })
        ...
        .then(user => {
            if (user) {
                ...
                user.socialLinks.twitter = data.twitter ? data.twitter : user.socialLinks.twitter;
                user.socialLinks.email = data.email ? data.email : user.socialLinks.email;
